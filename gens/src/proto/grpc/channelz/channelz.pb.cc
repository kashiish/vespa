...
descriptor_table_src_2fproto_2fgrpc_2fchannelz_2fchannelz_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_src_2fproto_2fgrpc_2fchannelz_2fchannelz_2eproto);
  return descriptor_table_src_2fproto_2fgrpc_2fchannelz_2fchannelz_2eproto.file_level_metadata[index];
}
