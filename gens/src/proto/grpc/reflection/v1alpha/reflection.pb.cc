...
descriptor_table_src_2fproto_2fgrpc_2freflection_2fv1alpha_2freflection_2eproto_metadata_getter(int index) {
  ...
  return descriptor_table_src_2fproto_2fgrpc_2freflection_2fv1alpha_2freflection_2eproto.file_level_metadata[index];
}
