...
enum LogMetric_ApiVersion {
  ...
  LogMetric_ApiVersion_LogMetric_ApiVersion_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  LogMetric_ApiVersion_LogMetric_ApiVersion_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
class LogMetric final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.LogMetric) */ {
 public:
  LogMetric();
  virtual ~LogMetric();
  ...
  PROTOBUF_DEPRECATED static const int kVersionFieldNumber = 4;
...
class ListLogMetricsRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.ListLogMetricsRequest) */ {
 public:
...
class ListLogMetricsResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.ListLogMetricsResponse) */ {
 public:
...
class GetLogMetricRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.GetLogMetricRequest) */ {
 public:
  GetLogMetricRequest();
...
class CreateLogMetricRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.CreateLogMetricRequest) */ {
 public:
...
class UpdateLogMetricRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.UpdateLogMetricRequest) */ {
 public:
...
class DeleteLogMetricRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.DeleteLogMetricRequest) */ {
 public:
...
inline const ::google::protobuf::Timestamp& LogMetric::create_time() const {
...
inline ::google::protobuf::Timestamp* LogMetric::release_create_time() {
...
inline ::google::protobuf::Timestamp* LogMetric::unsafe_arena_release_create_time() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.logging.v2.LogMetric.create_time)
  
  ::google::protobuf::Timestamp* temp = create_time_;
  create_time_ = nullptr;
  return temp;
}
inline ::google::protobuf::Timestamp* LogMetric::mutable_create_time() {
...
inline void LogMetric::set_allocated_create_time(::google::protobuf::Timestamp* create_time) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
...
inline const ::google::protobuf::Timestamp& LogMetric::update_time() const {
  const ::google::protobuf::Timestamp* p = update_time_;
  // @@protoc_insertion_point(field_get:google.logging.v2.LogMetric.update_time)
  return p != nullptr ? *p : *reinterpret_cast<const ::google::protobuf::Timestamp*>(
      &::google::protobuf::_Timestamp_default_instance_);
}
inline ::google::protobuf::Timestamp* LogMetric::release_update_time() {
...
inline ::google::protobuf::Timestamp* LogMetric::unsafe_arena_release_update_time() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.logging.v2.LogMetric.update_time)
  
  ::google::protobuf::Timestamp* temp = update_time_;
  update_time_ = nullptr;
  return temp;
}
inline ::google::protobuf::Timestamp* LogMetric::mutable_update_time() {
...
inline void LogMetric::set_allocated_update_time(::google::protobuf::Timestamp* update_time) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
