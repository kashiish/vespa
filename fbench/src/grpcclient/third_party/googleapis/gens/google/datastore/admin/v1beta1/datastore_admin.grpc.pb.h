   ...
   public:
    ...
    class async_interface {
     public:
      ...
      // cancelled before completion it may leave partial data behind in Google
      // Cloud Storage.
      virtual void ExportEntities(::grpc::ClientContext* context, const ::google::datastore::admin::v1beta1::ExportEntitiesRequest* request, ::google::longrunning::Operation* response, std::function<void(::grpc::Status)>) = 0;
      virtual void ExportEntities(::grpc::ClientContext* context, const ::google::datastore::admin::v1beta1::ExportEntitiesRequest* request, ::google::longrunning::Operation* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // Imports entities into Google Cloud Datastore. Existing entities with the
      // same key are overwritten. The import occurs in the background and its
      // progress can be monitored and managed via the Operation resource that is
      // created. If an ImportEntities operation is cancelled, it is possible
      // that a subset of the data has already been imported to Cloud Datastore.
      virtual void ImportEntities(::grpc::ClientContext* context, const ::google::datastore::admin::v1beta1::ImportEntitiesRequest* request, ::google::longrunning::Operation* response, std::function<void(::grpc::Status)>) = 0;
      virtual void ImportEntities(::grpc::ClientContext* context, const ::google::datastore::admin::v1beta1::ImportEntitiesRequest* request, ::google::longrunning::Operation* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
  ...
  class Stub final : public StubInterface {
   public:
    ...
    class async final :
     ...
     public:
      void ExportEntities(::grpc::ClientContext* context, const ::google::datastore::admin::v1beta1::ExportEntitiesRequest* request, ::google::longrunning::Operation* response, std::function<void(::grpc::Status)>) override;
      void ExportEntities(::grpc::ClientContext* context, const ::google::datastore::admin::v1beta1::ExportEntitiesRequest* request, ::google::longrunning::Operation* response, ::grpc::ClientUnaryReactor* reactor) override;
      void ImportEntities(::grpc::ClientContext* context, const ::google::datastore::admin::v1beta1::ImportEntitiesRequest* request, ::google::longrunning::Operation* response, std::function<void(::grpc::Status)>) override;
      void ImportEntities(::grpc::ClientContext* context, const ::google::datastore::admin::v1beta1::ImportEntitiesRequest* request, ::google::longrunning::Operation* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
   ...
   public:
    WithCallbackMethod_ExportEntities() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::google::datastore::admin::v1beta1::ExportEntitiesRequest, ::google::longrunning::Operation>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::google::datastore::admin::v1beta1::ExportEntitiesRequest* request, ::google::longrunning::Operation* response) { return this->ExportEntities(context, request, response); }));}
    void SetMessageAllocatorFor_ExportEntities(
        ::grpc::MessageAllocator< ::google::datastore::admin::v1beta1::ExportEntitiesRequest, ::google::longrunning::Operation>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::google::datastore::admin::v1beta1::ExportEntitiesRequest, ::google::longrunning::Operation>*>(handler)
    ...
    virtual ::grpc::ServerUnaryReactor* ExportEntities(
      ::grpc::CallbackServerContext* /*context*/, const ::google::datastore::admin::v1beta1::ExportEntitiesRequest* /*request*/, ::google::longrunning::Operation* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_ImportEntities() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::google::datastore::admin::v1beta1::ImportEntitiesRequest, ::google::longrunning::Operation>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::google::datastore::admin::v1beta1::ImportEntitiesRequest* request, ::google::longrunning::Operation* response) { return this->ImportEntities(context, request, response); }));}
    void SetMessageAllocatorFor_ImportEntities(
        ::grpc::MessageAllocator< ::google::datastore::admin::v1beta1::ImportEntitiesRequest, ::google::longrunning::Operation>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(1);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::google::datastore::admin::v1beta1::ImportEntitiesRequest, ::google::longrunning::Operation>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* ImportEntities(
      ::grpc::CallbackServerContext* /*context*/, const ::google::datastore::admin::v1beta1::ImportEntitiesRequest* /*request*/, ::google::longrunning::Operation* /*response*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_ExportEntities<WithCallbackMethod_ImportEntities<Service > > CallbackService;
    ...
    WithStreamedUnaryMethod_ExportEntities() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::google::datastore::admin::v1beta1::ExportEntitiesRequest, ::google::longrunning::Operation>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::google::datastore::admin::v1beta1::ExportEntitiesRequest, ::google::longrunning::Operation>* streamer) {
   ...
   public:
    WithStreamedUnaryMethod_ImportEntities() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler<
          ::google::datastore::admin::v1beta1::ImportEntitiesRequest, ::google::longrunning::Operation>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::google::datastore::admin::v1beta1::ImportEntitiesRequest, ::google::longrunning::Operation>* streamer) {
