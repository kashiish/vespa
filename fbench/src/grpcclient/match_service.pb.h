...
#ifndef GOOGLE_PROTOBUF_INCLUDED_match_5fservice_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_match_5fservice_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_match_5fservice_2eproto;
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_match_5fservice_2eproto_metadata_getter(int index);
namespace google {
namespace cloud {
...
class MatchRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_match_5fservice_2eproto_metadata_getter(kIndexInFileMessages);
  }
  ...
  void _internal_set_deployed_index_id(const std::string& value);
...
class MatchResponse_Neighbor PROTOBUF_FINAL :
...
class BatchMatchRequest_BatchMatchRequestPerIndex PROTOBUF_FINAL :
...
class BatchMatchRequest PROTOBUF_FINAL :
...
class BatchMatchResponse_BatchMatchResponsePerIndex PROTOBUF_FINAL :
...
class BatchMatchResponse PROTOBUF_FINAL :
...
inline void MatchRequest::set_deployed_index_id(const std::string& value) {
  _internal_set_deployed_index_id(value);
...
inline std::string* MatchRequest::mutable_deployed_index_id() {
  ...
  return _internal_mutable_deployed_index_id();
}
...
inline void MatchRequest::_internal_set_deployed_index_id(const std::string& value) {
  ...
  deployed_index_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void MatchRequest::set_deployed_index_id(std::string&& value) {
  
  deployed_index_id_.Set(
...
inline void MatchRequest::set_deployed_index_id(const char* value) {
  ...
  deployed_index_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:google.cloud.aiplatform.container.v1beta1.MatchRequest.deployed_index_id)
}
inline void MatchRequest::set_deployed_index_id(const char* value,
    size_t size) {
  
  deployed_index_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* MatchRequest::_internal_mutable_deployed_index_id() {
  ...
  return deployed_index_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* MatchRequest::release_deployed_index_id() {
  ...
  return deployed_index_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline ::google::cloud::aiplatform::container::v1beta1::Namespace* MatchRequest::add_restricts() {
  ...
  return _internal_add_restricts();
}
...
inline std::string* Namespace::add_allow_tokens() {
  ...
  return _internal_add_allow_tokens();
}
...
inline std::string* Namespace::add_deny_tokens() {
  ...
  return _internal_add_deny_tokens();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_match_5fservice_2eproto
